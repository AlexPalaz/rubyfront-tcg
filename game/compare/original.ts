...
// renderer (docs/cards/ui/card-render.js) — compresa la seconda passata del
// fit che il gioco fa sulle sue (painter.ts: almeno 14px d'aria sotto
// l'ultima riga). È il metro: la carta Pixi si misura contro questa.
...
// Caricati dal loro percorso vero, non bundlati:
...
/** La seconda passata del fit, identica a quella del gioco (painter.ts). */
function secondFit(root: Element): void {
