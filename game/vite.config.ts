...
export default defineConfig(({ command }) => ({
  ...
  // Porta fissa: le impostazioni vivono nel localStorage dell'origine, e
  // un'origine che cambia porta le perde.
  server: { port: 5200, strictPort: true },
  build: {
    // La radice del sito; il catalogo lo copia dopo scripts/build-site.mjs.
