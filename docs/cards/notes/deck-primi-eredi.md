...
| Abilità | **+3 PV** Comando dal Fronte: stappa fino a 2 Umani | **+3 PV** Ordine del Fronte: stappa **tutti** gli Umani |
| Abilità | −3 PV Onda Portante: Umani +1 Potenza | −7 PV Grande Marea: le tue Entità +1 e non bloccabili da Potenza superiore |
| Abilità | −5 PV Richiamo del Patto: cerca un Umano da ≤3 | — |
| Furia | 1 | **nessuna** |
...
- **Comando dal Fronte restituisce PV invece di costarli.** È l'unica abilità del
  set che paga il proprietario, e rende la bestia una fonte di cura oltre che di
  tempo.
...
**Assenza**. Adam la trova con Genesi, ma la carta cercata non si può giocare né
scartare nel turno in cui arriva — quindi il flip cade sempre **almeno un turno
dopo** che Genesi ha risolto. La decisione ricorrente è se spendere Assenza come
rimozione o conservarla come carburante del flip.
...
| T4 | 4 | **Rubifronte del Patto**: Vendicatrice e Vigorcintura salgono, Comando dal Fronte stappa il Guardiano e restituisce 3 PV |
...
difende: è esattamente il malus che Comando dal Fronte e Ordine del Fronte
cancellano. È la sinergia più stretta del mazzo.
