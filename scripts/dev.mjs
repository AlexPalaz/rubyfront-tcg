...
//
//   npm run all                 (dalla radice)
//
// Accende i due pezzi — il gioco in PixiJS (vite, :5200) e il tavolo
// (l'engine Ruby, :8788) — con i log incolonnati per voce, e un solo Ctrl+C
...
console.log("Tavolo in accensione: gioco http://localhost:5200/ · engine :8788");
