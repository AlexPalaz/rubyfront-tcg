...
//
// Il catalogo, una volta caricato, va all'anagrafe del core
// (@rubyfront/core/cards, `useCatalog`): nomi, statistiche e forme
// certificate si leggono da lì, e questo modulo le ripete per le viste.

export * from "@rubyfront/core/cards";
