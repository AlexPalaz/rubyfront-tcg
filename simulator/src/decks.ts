...
export function mountDeckView(host: HTMLElement, onPlay: (deckId: string) => void, onClose: () => void): DeckView {
  host.innerHTML = "";

  const bar = document.createElement("div");
  bar.className = "decks-bar";
  const back = document.createElement("button");
  back.type = "button";
  back.className = "decks-back";
  back.textContent = t("decks.back");
  ...
  title.textContent = t("decks.title");
  const lead = document.createElement("p");
  lead.className = "decks-lead";
  lead.textContent = t("decks.lead");
  bar.append(back, title, lead);

  const shelf = document.createElement("div");
  shelf.className = "decks-shelf";
  ...
  function deckPrint(deck: CatalogDeck): HTMLElement {
    ...
    browse.addEventListener("click", () => {
      ...
      browse.textContent = t(opening ? "decks.browse.close" : "decks.browse");
