...
const M: Record<string, { it: string; en: string }> = {
  ...
  "html.sound.on": { it: "Accesi", en: "On" },
  "html.music": { it: "Musica", en: "Music" },
  "html.music.on": { it: "Nelle battaglie", en: "In battles" },
  "html.music.tip": { it: "Il brano delle battaglie: parte con la Fase di Fronte, si spegne al cambio di turno", en: "The battle track: starts with the Front Phase, fades at the turn change" },
  "html.sound.tip": { it: "I suoni del tavolo: tocchi, tasti, carte, attacchi", en: "The table's sounds: touches, buttons, cards, attacks" },
